...
import sty from "./PlasmicObservable.module.css"; // plasmic-import: pJvKZ0pf7kjH/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: dwguQLcqWY5Z/icon
...
function PlasmicObservable__RenderFunc(props: {
  ...
  return (
    ...
    >
      <Embed
        className={classNames("__wab_instance", sty.embedHtml__ul43E)}
        code={
      ...
      <Embed
        className={classNames("__wab_instance", sty.embedHtml__qmQo7)}
        code={""}
      />
    </div>
