...
import sty from "./PlasmicFooter.module.css"; // plasmic-import: idXyxaW15Mdl/css

import LinkedinSvgrepoComsvgIcon from "./icons/PlasmicIcon__LinkedinSvgrepoComsvg"; // plasmic-import: ioK3CdBHQcoP/icon
...
function PlasmicFooter__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__e73Kw)}>
        <div className={classNames(projectcss.all, sty.freeBox___6H9JP)}>
          <div
            className={classNames(
              projectcss.all,
          ...
          <div className={classNames(projectcss.all, sty.freeBox__hoCk)}>
            <div
              className={classNames(
                projectcss.all,
                projectcss.__wab_text,
            ...
            <p.Stack
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__x5MdR)}
              onClick={async event => {
                const $steps = {};
                ...
                if (
                  ...
                  typeof $steps["goToHttpswwwlinkedincomcompanybuildSystemsDe"]
                    .then === "function"
                ) {
                  $steps["goToHttpswwwlinkedincomcompanybuildSystemsDe"] =
                    await $steps[
