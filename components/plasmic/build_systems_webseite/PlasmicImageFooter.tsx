...
import ButtonExternalLink from "../../ButtonExternalLink"; // plasmic-import: FnP1WiPL04V2/component
import Footer from "../../Footer"; // plasmic-import: idXyxaW15Mdl/component
...
import sty from "./PlasmicImageFooter.module.css"; // plasmic-import: BSa7gVRQINSW/css
...
function PlasmicImageFooter__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__eC4Tu)}>
        <p.PlasmicImg
        ...
        <div className={classNames(projectcss.all, sty.freeBox__kuo87)} />

        <div className={classNames(projectcss.all, sty.freeBox__q7J01)}>
          <div className={classNames(projectcss.all, sty.freeBox__heI3P)}>
            <div className={classNames(projectcss.all, sty.freeBox__hKeLz)}>
              <div
                className={classNames(
                  projectcss.all,
