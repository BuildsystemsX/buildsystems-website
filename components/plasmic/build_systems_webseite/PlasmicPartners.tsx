...
import sty from "./PlasmicPartners.module.css"; // plasmic-import: Lte0kfo9RaXd/css
...
function PlasmicPartners__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___0DieM)}>
        <div className={classNames(projectcss.all, sty.freeBox__kIy0)}>
          <p.PlasmicImg
            alt={""}
            className={classNames(sty.img__q31V)}
            displayHeight={"auto"}
        ...
        <div className={classNames(projectcss.all, sty.freeBox__fhdyQ)}>
          <p.PlasmicImg
            alt={""}
            className={classNames(sty.img__qSdj)}
            displayHeight={"auto"}
            displayMaxHeight={"none"}
            displayMaxWidth={
        ...
        <div className={classNames(projectcss.all, sty.freeBox___3Uf1K)}>
          <p.PlasmicImg
            alt={""}
            className={classNames(sty.img__oBl4R)}
            displayHeight={"auto"}
            displayMaxHeight={"none"}
            displayMaxWidth={
        ...
        <div className={classNames(projectcss.all, sty.freeBox__zdt7)}>
          <p.PlasmicImg
            alt={""}
            className={classNames(sty.img___1QOfE)}
            displayHeight={"auto"}
            displayMaxHeight={"none"}
            displayMaxWidth={"100%"}
            displayMinHeight={"0"}
        ...
        <div className={classNames(projectcss.all, sty.freeBox__fXWm)}>
          <p.PlasmicImg
            alt={""}
            className={classNames(sty.img___4JV3C)}
            displayHeight={"auto"}
            displayMaxHeight={"none"}
            displayMaxWidth={"100%"}
            displayMinHeight={"0"}
        ...
        <div className={classNames(projectcss.all, sty.freeBox__nMNxh)}>
          <p.PlasmicImg
            alt={""}
            className={classNames(sty.img__egtWv)}
            displayHeight={"auto"}
            displayMaxHeight={"none"}
            displayMaxWidth={"100%"}
            displayMinHeight={"0"}
        ...
        <div className={classNames(projectcss.all, sty.freeBox__suw8R)}>
          <p.PlasmicImg
            alt={""}
            className={classNames(sty.img__lHu4X)}
            displayHeight={"auto"}
            displayMaxHeight={"none"}
            displayMaxWidth={"100%"}
            displayMinHeight={"0"}
        ...
        <div className={classNames(projectcss.all, sty.freeBox__xayCw)}>
          <p.PlasmicImg
            alt={""}
            className={classNames(sty.img__pkvut)}
            displayHeight={"auto"}
            displayMaxHeight={"none"}
            displayMaxWidth={"100%"}
            displayMinHeight={"0"}
